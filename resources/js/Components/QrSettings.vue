...
<template>
    ...
    >
        ...
        <button
            ...
            class="absolute right-0 top-0 hover:bg-green-honeydew p-[0.25rem] rounded-full text-black-charcoal transition-all duration-500 ease-in-out bg-gray-100 mr-[1rem] mt-[1rem] z-[1]">
        ...
        <div
            ...
            class="absolute left-0 top-0 w-full h-full rounded-[8px] transition-all transform-gpu duration-500 ease-in-out bg-white text-left px-[2rem]"
        >
            <h2 class="text-base leading-tight text-black-charcoal font-semibold text-center py-[1.5rem]">Settings</h2>
